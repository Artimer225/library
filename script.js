...
const bookDialog = document.querySelector('#create-dialog');
...
bookTitle.addEventListener('invalid', (e) => {
 const el = e.target;
  ...
  if (el.validity.valueMissing) {
    el.setCustomValidity('Please, enter the title of the book');
  }
})
...
displayLibrary(library.storage);
